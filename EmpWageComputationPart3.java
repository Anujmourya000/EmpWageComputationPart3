...
public class EmpWageComputationPart3 {
	...
	//Constructor
	public EmpWageComputationPart3(int WAGE_PER_HOUR, int FULL_DAY_HOUR, int HALF_DAY_HOUR) {
	...
	public static void main(String[] args) {
		...
		EmpWageComputationPart3 empWage1 = new EmpWageComputationPart3(20, 8, 0);
		EmpWageComputationPart3 empWage2 = new EmpWageComputationPart3(20, 0, 4);
